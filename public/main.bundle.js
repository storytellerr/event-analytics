...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_angular_bootstrap_md__ = __webpack_require__("../../../../angular-bootstrap-md/index.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_16_angular_bootstrap_md__["a" /* MDBBootstrapModule */].forRoot(),
...
module.exports = "<h2 class=\"page-header\">Dashboard</h2>\n<p>Welcome to your Dashboard</p>\n<button type=\"button\" (click)=\"makeRequest()\">Make Request</button>\n<div *ngIf=\"loading\">loading...</div>\n<pre>Data Obtained iss: {{value}}</pre>\n\n<div class=\"row\" style=\"width:100%\">\n    <div  style=\"display: block; width:70%\">\n        <canvas mdbChart\n            [chartType]=\"chartType\"\n            [datasets]=\"chartDatasets\"\n            [labels]=\"chartLabels\"\n            [colors]=\"chartColors\"\n            [options]=\"chartOptions\"\n            [legend]=\"true\"\n            (chartHover)=\"chartHovered($event)\"\n            (chartClick)=\"chartClicked($event)\">\n        </canvas>\n    </div>\n    <div  style=\"display: block; width:30%\">\n      <div class=\"row\" style=\"display: block; width:100%;height:5%;padding-left:35px\">\n        total events={{eventval}}\n      </div>\n      <div class=\"row\" style=\"display: block; width:100%;height:20%\">\n          <div style=\"display: block\">\n              <canvas mdbChart\n                  [chartType]=\"chartType1\"\n                  [data]=\"chartData1\"\n                  [labels]=\"chartLabels1\"\n                  [colors]=\"chartColors1\"\n                  [options]=\"chartOptions\"\n                  [legend]=\"true\"\n                  (chartHover)=\"chartHovered($event)\"\n                  (chartClick)=\"chartClicked($event)\">\n              </canvas>\n          </div>\n      </div>\n    </div>\n</div>\n\n<div>\n  logs ={{logs}}\n</div>\n"
...
var DashboardComponent = (function () {
    ...
    function DashboardComponent(http, authService) {
        ...
        this.chartData1 = [300, 50, 100, 40];
        this.chartLabels1 = ['Red', 'Green', 'Yellow', 'Grey', 'Dark Grey'];
        this.chartColors1 = [{
    ...
    DashboardComponent.prototype.makeRequest = function () {
        var _this = this;
        this.loading = true;
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"], __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */]])
    ], DashboardComponent);
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>App analytics platform</h1>\n  <p class=\"lead\">Welcome to our custom application analytics platform  </p>\n  <div *ngIf=\"!authService.loggedIn()\">\n    <a class=\"btn btn-primary\"  [routerLink]=\"['/register']\">Register</a> <a class=\"btn btn-dark\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div>\n  <h3>how to use<h3>\n  <div class=\"jumbotron text-center\">\n    <h3><b>Step1</b></h3>\n    login/register to the portal by navigating to login/register through nav-bar.\n    <h3><b>Step2</b></h3>\n    add library to your app via jet pack\n\n\n    <div class=\"taboption\">\n    <button class=\"tablinks\"  [style.background-color]=\"show ? '#ccc':'#f1f1f1'\" (click)=\"changeTab(1)\">android studio-2.*</button>\n    <button class=\"tablinks\"  [style.background-color]=\"!show ? '#ccc':'#f1f1f1' \" (click)=\"changeTab(2)\" >android studio-3.*</button>\n    </div>\n\n    <div id=\"Tab1\" class=\"tabcontent\" *ngIf=\"show\">\n      <div class=\"jumbotron text-center \">\n        1.Add it in your root build.gradle at the end of repositories:\n        <img src=\"assets/images/app-gradle.png\"  alt=\"Avatar\">\n        2.Add the dependency\n        <img src=\"assets/images/module-gradle.png\"  alt=\"Avatar\">\n      </div>\n    </div>\n\n   <div id=\"Tab2\" class=\"tabcontent\" *ngIf=\"!show\">\n     <div class=\"jumbotron text-center\">\n       1.Add it in your root build.gradle at the end of repositories:<br>\n       <img src=\"assets/images/app-gradle.png\"  alt=\"Avatar\"><br>\n       2.Add the dependency<br>\n        <img src=\"assets/images/module-gradle.png\"  alt=\"Avatar\">\n     </div>\n   </div>\n\n\n    <h3><b>Step3</b></h3>\n    goto dashboard and show the data\n  </div>\n<div>\n\n<div>\n  <h3 style=\"text-align: center;\">Created By</h3>\n  <div  id=\"container\" class=\"createdby\" >\n    <div class=\"row\">\n      <img src=\"assets/images/akash.jpg\" class=\"imgg\" alt=\"Avatar\">\n      <div style=\"text-align: center;\"><a href=\"https://www.facebook.com/akashdeep.singh.944023\">akash</a></div>\n    </div>\n    <div class=\"row\">\n      <img src=\"assets/images/yaten.jpg\" class=\"imgg\" alt=\"Avatar\" >\n      <div style=\"text-align: center;\"><a href=\"https://www.facebook.com/yatender.yaten\">yeten</a></div>\n    </div>\n    <div class=\"row\">\n      <img src=\"assets/images/shashank.jpg\" class=\"imgg\" alt=\"Avatar\" >\n      <div style=\"text-align: center;\"><a href=\"https://www.facebook.com/akashdeep.singh.944023\">Shashank</a></div>\n    </div>\n  </div>\n</div>\n"
...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.changeTab = function (i) {
        if (i == 1)
            this.show = true;
        if (i == 2)
            this.show = false;
